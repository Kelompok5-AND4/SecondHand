...
class EditProductViewModel @Inject constructor(private val repository: Repository) :ViewModel(){
    private val _editProduct = MutableLiveData<Resource<SellProductResponse>>()
    val editProduct : LiveData<Resource<SellProductResponse>> get() = _editProduct
    ...
    fun editProduct(
        ...
        viewModelScope.launch {
            _editProduct.postValue(Resource.loading())
            try {
                _editProduct.postValue(
                    Resource.success(repository.editProduct(
                    token,id,
                    gambarProduk,
                    namaRequestBody,
                ...
                _editProduct.postValue(Resource.error(e.localizedMessage?:"Error occured"))
            }
        }
    }
