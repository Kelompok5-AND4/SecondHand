...
class PengajuanDiterimaFragment : Fragment() {
    ...
    private var _binding: FragmentPengajuanDiterimaBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPengajuanDiterimaBinding.inflate(inflater,container, false)
                ...
                when (it.status) {
                    ...
                    Status.SUCCESS -> {
                        if (it.data.isNullOrEmpty()) {
                            ...
                            binding.rvAccepted.adapter = buyerAdapter
                        }
